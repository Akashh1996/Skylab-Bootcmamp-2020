...
function getTheId(){
    ...
    seletedHeroInfoDisplay(currentId);
    return currentId;
}
function seletedHeroInfoDisplay(index){
    for (var property in superHeroes[index]) {
        if (Object.prototype.hasOwnProperty.call(superHeroes[index], property)) {
            if(property === "id"){
                ...
                for (var property2 in superHeroes[index].powerstats) {
                    if (Object.prototype.hasOwnProperty.call(superHeroes[index].powerstats, property2)) {
                        if(property2 === "intelligence"){
                            document.getElementById("Property4.1").innerHTML = property2 + ": " + superHeroes[index].powerstats[property2];
                        }
                        if(property2 === "strength"){
                            document.getElementById("Property4.2").innerHTML = property2 + ": " + superHeroes[index].powerstats[property2];
                        }
                        if(property2 === "speed"){
                            document.getElementById("Property4.3").innerHTML = property2 + ": " + superHeroes[index].powerstats[property2];
                        }
                        if(property2 === "durability"){
                            document.getElementById("Property4.4").innerHTML = property2 + ": " + superHeroes[index].powerstats[property2];
                        }
                        if(property2 === "power"){
                            document.getElementById("Property4.5").innerHTML = property2 + ": " + superHeroes[index].powerstats[property2];
                        }
                        if(property2 === "combat"){
                            document.getElementById("Property4.6").innerHTML = property2 + ": " + superHeroes[index].powerstats[property2];
                        }
                    }
                }
            }
