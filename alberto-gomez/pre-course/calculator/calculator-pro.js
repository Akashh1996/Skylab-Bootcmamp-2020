function calculator() {
  ...
  function sum() {
    ...
    console.log(`La suma de los números elegidos es igual a ${parseFloat(numbers_sum.toFixed(3))}`);
    return numbers_sum;
  }
  ...
  function subs() {
    ...
    console.log(`La resta de los números elegidos es igual a ${parseFloat(numbers_subs.toFixed(3))}`)
    return numbers_subs;
  }
  ...
  function mult() {
    ...
    console.log(`La multiplicación de los números elegidos es igual a ${parseFloat(numbers_mult.toFixed(3))}`);
    return numbers_mult;
  }
  ...
  function div() {
    ...
    console.log(`La división de los números elegidos es igual a ${parseFloat(numbers_div.toFixed(3))}`);
    return numbers_div;
  }
