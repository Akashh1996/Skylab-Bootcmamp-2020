...
class Store {
	...
	setDashboard (){
		var array = this.getHeroes();
		var liElem = '';
		for (var heroe = 0; heroe < this.getTopHeroes().length; heroe++) {
			liElem +=
				`<li class="demoClass"><a href ="./view/detail.html?id=${array[heroe].id}">${array[heroe].name}</a></li>`;
		}
		return liElem;
	};
	...
	anchorListOfHeroes () {
		var array = this.getHeroes();
		var liElem = '';
		for (var heroe = 0; heroe < array.length; heroe++) {
			liElem +=
				`<li class="demoClass"><a href ="./view/detail.html?id=${array[heroe].id}">${array[heroe].name}</a></li>`;
		}
		return liElem;
