...
console.log(
	'El juego estará basado en las películas Disney, saga Marvel, y saga Harry Potter, ¿ Vemos cuanto eres capaz de recordar sobre estas películas que seguro has visto? Empezamos!'
);
console.log(
	'Escribe las respuestas sin acentos, sin signos, y puedes responder "END" si prefieres finalizar el juego.'
);
...
var pasapalabra = () => {
	...
	if (ACIERTOS + FALLOS != 27) return pasapalabra();
		...
		porAciertos.sort(function (c, b) {
			return b.ACIERTOS - c.ACIERTOS;
		});
