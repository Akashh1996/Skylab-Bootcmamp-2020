...
function startCalculator() {
	//Nos permite conocer si debemos almacenar nuevos resultados
...
function getNumbers() {
	//Nos permite obtener los valores a tratar
...
function squareRoot(num1) {
	//Realiza la raiz cuadrada cuando se introduce un solo valor
...
function calculatorPro(args) {
	function sum(...argts) {
		//Realiza la suma de cualquier cantidad de valores introducidos
		return argts.reduce(function (acc, cur) {
			return acc + cur;
		});
	}

	function subt(...argts) {
		//Realiza la resta de cualquier cantidad de valores introducidos
		return argts.reduce(function (acc, cur) {
			return acc - cur;
		});
	}

	function multi(...argts) {
		//Realiza la multiplicación de cualquier cantidad de valores introducidos
		return argts.reduce(function (acc, cur) {
			return acc * cur;
		});
	}
	...
	function div(...argts) {
		//Realiza la division de cualquier cantidad de valores introducidos
		return argts.reduce(function (acc, cur) {
