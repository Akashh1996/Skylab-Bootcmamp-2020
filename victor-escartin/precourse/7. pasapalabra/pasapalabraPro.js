...
function pasapalabra() { 
    ...
    for (var i = 0; i < chosenQuestions.length; i++) {
        if (chosenQuestions[i]["status"] === 0) {
            ...
            if (answer == null || answer === "end" || answer == "null" || answer==="") {
    ...
    for (let z=0; z<ranking.length; z++){
        console.log(ranking[z].name +": "+ ranking[z].rights +" ACIERTOS, "+ ranking[z].wrongs +" FALLOS");
    }
