...
class SpotifyStore {
	...
	async getSeveralArtist() {
		const response = await fetch(
			`https://api.spotify.com/v1/artists?ids=2xiIXseIJcq3nG7C8fHeBj,7BqEidErPMNiUXCRE0dV2n,5eAWCfyUhZtHHtBdNk56l1,24Hb4GKFYquK73R8mTyInu,3TOqt5oJwL9BE2NG9MEwDa,50hbotxVDC7jjk24PfKJa2,6XyY86QOPPrYVGvF9ch6wz,0Tob4H0FLtEONHU1MjpUEp,49bzE5vRBRIota4qeHtQM8`,
			{
				method: 'GET',
