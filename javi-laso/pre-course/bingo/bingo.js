...
function bombo(arr) { // arr es el array de numeros que ya han salido, asi da un numero nuevo cada vez
...
function askNewTurn() {
    var question = prompt('¿Quieres otro numero? Si/No');

    if (question === null) {
        return false;
    } else if (question.toLowerCase() === 'si' || question.toLowerCase() === 's') {
        return true;
    } else {
        return false;
    }    
